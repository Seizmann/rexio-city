 ...
 * DESIGN.md §4: same nav items as BottomNav.
 * Visible ≥768px; BottomNav hidden on desktop.
 */
export default function Sidebar({ username }: { username: string }) {
  ...
  const items: NavItem[] = [
    ...
    { href: ROUTES.NOTIFICATIONS, label: 'Notifications', icon: icons.notifications },
